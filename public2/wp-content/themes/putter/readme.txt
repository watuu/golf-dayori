...
WordPress version: required at least 5.0, tested up to 5.9.3
...
Please install and activate it before starting to use the theme Putter.
...
Theme documentation is available on https://putter.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Putter is Fontello.
