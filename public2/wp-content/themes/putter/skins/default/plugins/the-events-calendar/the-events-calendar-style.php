...
if ( ! function_exists( 'putter_tribe_events_get_css' ) ) {
	add_filter( 'putter_filter_get_css', 'putter_tribe_events_get_css', 10, 2 );
	function putter_tribe_events_get_css( $css, $args ) {
