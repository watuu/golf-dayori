...
if ( ! function_exists( 'putter_woocommerce_get_css' ) ) {
	add_filter( 'putter_filter_get_css', 'putter_woocommerce_get_css', 10, 2 );
	function putter_woocommerce_get_css( $css, $args ) {
...
$fdir = putter_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}
