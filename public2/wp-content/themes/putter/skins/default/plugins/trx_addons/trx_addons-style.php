...
if ( ! function_exists( 'putter_trx_addons_get_css' ) ) {
	add_filter( 'putter_filter_get_css', 'putter_trx_addons_get_css', 10, 2 );
	function putter_trx_addons_get_css( $css, $args ) {
